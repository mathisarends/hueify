...
class TestGroupController(unittest.TestCase):
    def setUp(self):
        ...
        self.test_groups = {
            "1": {
                ...
                "recycle": False,
                "class_": "Living room",
                "action": {"on": True, "bri": 144, "hue": 8402, "sat": 140, "effect": "none", "xy": [0.4575, 0.4101], "ct": 366, "alert": "none", "colormode": "ct"}
            }
        }
    ...
    async def mock_put_request(self, endpoint, data):
        ...
        return [{"success": {f"/groups/1/action/{key}": value} for key, value in data.items()}]
    ...
    def test_turn_on(self):
        ...
        self.bridge_mock.put_request.assert_called_with("groups/1/action", {"on": True, "transitiontime": 4})
    ...
    def test_set_brightness(self):
        ...
        # Überprüfe, dass der richtige API-Call gemacht wurde
        self.bridge_mock.put_request.assert_called_with("groups/1/action", {"on": True, "bri": expected_brightness, "transitiontime": None})
